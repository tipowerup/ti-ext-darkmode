...
return [
    'form' => [
        ...
        'fields' => [
            ...
            'latitude' => [
                ...
                'trigger' => [
                    'action' => 'show',
                    'field' => 'schedule_type',
                    'condition' => 'value[sunset_sunrise]',
                ],
            ],
            'longitude' => [
        ...
        'rules' => [
            ...
            ['latitude', 'lang:tipowerup.darkmode::default.label_latitude', 'nullable|numeric|min:-90|max:90'],
            ['longitude', 'lang:tipowerup.darkmode::default.label_longitude', 'nullable|numeric|min:-180|max:180'],
